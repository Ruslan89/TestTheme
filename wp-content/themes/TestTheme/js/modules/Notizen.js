...
class Notizen {
	...
	events() {
		...
		//this.createButton.click(this.createNote.bind(this));

	}

	//methods JSON=Abfrage, ajax=bearbeiten
	editNote(e) {
	...
	deleteNote(e) {
		...
		$.ajax({
			...
			url: guData.root_url + '/wp-json/wp/v2/notiz/' + thisNote.data('id'),
			type: 'DELETE', 
			success: (response) => {
				thisNote.slideUp();
				console.log("Congrats");
				console.log(response);
				if(response.userNoteCount < 101) {
